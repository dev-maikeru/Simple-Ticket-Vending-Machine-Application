...
@Service
public class DiscountedCardService implements ICard {
    private final CardRepository cardRepository;

    public DiscountedCardService(CardRepository cardRepository) {
    ...
    public Card createTransportCard(Card card) {
        ...
        TransportCardUtils.setDiscountedCardExpiryDate(tc);
